import type { GoalImportance } from './goal-utils';

export interface SuggestedHabitGoal {
	title: string;
	category: 'Physical' | 'Mental' | 'Personal' | 'Relationships' | 'Creative' | 'Wellness';
	timesPerWeek?: number;
...
const HABIT_VARIANTS = [
	...
	{ suffix: 'for 15 minutes', timesPerWeek: 6, importance: 'low' as const },
	{ suffix: 'for 20 minutes', timesPerWeek: 6, importance: 'medium' as const },
	{ suffix: 'for 30 minutes', timesPerWeek: 7, importance: 'high' as const },
	{ suffix: 'before lunch', timesPerWeek: 5, importance: 'default' as const },
	{ suffix: 'before dinner', timesPerWeek: 5, importance: 'medium' as const },
	{ suffix: 'before bed', timesPerWeek: 7, importance: 'high' as const },
	{ suffix: 'right after waking up', timesPerWeek: 6, importance: 'medium' as const },
	{ suffix: 'after your first meal', timesPerWeek: 5, importance: 'default' as const },
	{ suffix: 'after work or class', timesPerWeek: 5, importance: 'medium' as const },
	{ suffix: 'before you check social media', timesPerWeek: 6, importance: 'high' as const },
	{ suffix: 'with zero multitasking', timesPerWeek: 4, importance: 'medium' as const },
	{ suffix: 'and log how it felt', timesPerWeek: 4, importance: 'medium' as const },
	{ suffix: 'on low-energy days', timesPerWeek: 3, importance: 'default' as const },
	{ suffix: 'on your busiest weekday', timesPerWeek: 1, importance: 'medium' as const },
	{ suffix: 'on both weekend days', timesPerWeek: 2, importance: 'low' as const },
	{ suffix: 'for one focused round', timesPerWeek: 5, importance: 'high' as const },
];
...
export const SUGGESTED_HABIT_GOALS: SuggestedHabitGoal[] = [
	...
	...buildHabitCategory('Relationships', RELATIONSHIP_HABITS),
