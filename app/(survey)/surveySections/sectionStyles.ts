...
export const sectionStyles = StyleSheet.create({
	...
	miniButton: { minWidth: 48, height: 32, borderRadius: 6, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 8 },
	...
	subGoalRow: { flexDirection: 'row', alignItems: 'center', paddingLeft: 12, paddingVertical: 6 },
	metaRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 6 },
	importanceText: { fontSize: 12, fontWeight: '800' },
	categoryChip: { paddingVertical: 4, paddingHorizontal: 8, borderRadius: 999, backgroundColor: '#F3F4F6', borderWidth: 1, borderColor: '#E5E7EB' },
	categoryChipText: { fontSize: 11, fontWeight: '700', color: '#374151' },
